...
/**
 * Servlet implementation class createPlanning
 */
@WebServlet("/createPlanning")
public class createPlanning extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("Gerant/Planning/create.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Planning planning = new Planning(null, terrain, date1, 1l);
