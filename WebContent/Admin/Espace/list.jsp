                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <c:forEach var="item" items="${requestScope.espaces}" >
                                     <tr>
                                     		<td>${item['gerer']['nom'] } ${item['nom_esp']['prenom'] }</td>
                                    		<td>${item['nom_esp'] }</td>
	                                        <td>${item['desc_esp']}</td>
	                                        <td>${item['liked']}</td>
	                                        <td>${item['deslike']}</td>
	                                        ...
	                                        <td>
	                                        	<a href="modifierEspaceAdmin?update=${item['id_esp']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterEspaceAdmin?consulter=${item['id_esp']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
                                    </tfoot>
