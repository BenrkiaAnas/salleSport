...
<head>
    ...
    <title>Crée Espace Sportif</title>
    <meta name="viewport"
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    ...
                                    <div class="position-relative row form-group">
                                            <label for="categorie" class="col-sm-2 col-form-label">Gérant</label>
                                            <div class="col-sm-10">
                                                 <select class="mb-2 form-control" name="gerant">
                                                 <c:forEach var="item" items="${requestScope.gerants}" >
														   <option value="${item['id_personne'] }">${item['nom']} ${item['prenom']}</option>
													</c:forEach>
                                            </select>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nom" value="" id="Nom" placeholder="Nom de l'espace Sportif" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="Description" class="form-control" placeholder="Description de l'space sportif"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2" style="padding: 0px !important">
                                                <input value="Crée" type="submit" class="btn btn-primary" />
                                            </div>
                                        </div>
                                    </form>
