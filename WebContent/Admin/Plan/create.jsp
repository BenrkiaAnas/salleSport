                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" method="POST" action="">
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nom" id="nomplan" placeholder="Nom de plan" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="prixplan" class="col-sm-2 col-form-label">prix plan</label>
                                            <div class="col-sm-10">
                                                <input name="prix" id="prixplan" placeholder="Prix de plan" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="Descriptionplan" class="form-control" placeholder="Description de plan"></textarea>
                                            </div>
                                        </div>
