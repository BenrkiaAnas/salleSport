...
<head>
      <title>Consultation de Terrain</title>
    <meta charset="utf-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label for="NomT" class=" col-form-label">${requestScope.terrain['nom_ter']}</label>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Prix</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="Description" class=" ">${requestScope.terrain['prix']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                             <div>
                                             	<img alt="" src="./images/${requestScope.terrain['img_ter']}" style="width: 150px;height: 90px"> 
                                             </div>
                                            </div>
                                        </div>
                                      <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                ${requestScope.terrain['statut'] == 1 ? 'Activer' : 'Desactiver'}                                             
                                                </label>                                             
                                            </div>                                      
                                      </div>
                                    </form>
