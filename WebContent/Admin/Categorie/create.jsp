                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" enctype="multipart/form-data" method="POST" action="">
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nom" id="nom" placeholder="Nom de Catégorie" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="description" class="form-control" placeholder="Description de Catégorie"></textarea>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
