                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <c:forEach var="item" items="${requestScope.categories}" >
                                     <tr>
	                                        ...
	                                        <td>
	                                        	<a href="modifierCategorie?update=${item['id_cate']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterCategorie?consulter=${item['id_cate']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
