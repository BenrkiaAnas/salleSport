                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" enctype="multipart/form-data" method="POST" action="">
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nom" value="${requestScope.categorie['nom_cate']}" id="nom" placeholder="Nom de Catégorie" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="description" class="form-control" placeholder="Description de Catégorie">${requestScope.categorie['desc_cate']}</textarea>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check">
                                                    <label class="form-check-label">
                                                        <input ${requestScope.categorie['statut'] == 1 ? 'checked' : ''} id="check" name="statut" type="checkbox" class="form-check-input " style="margin-top: 0px"!important>
                                                    </label>
                                                </div>
                                            </div>
                                        <div>
