                                    ...
                                    <ul  class="mm-show"   >
                                        <li>
                                            <a href="tables-data-tables.html"  class="mm-active" >
                                                <i class="metismenu-icon"> </i>Liste Gérant
                                            </a>
                                        </li>
                                        <li>
                        ...
                        <div class="app-page-title">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                   <c:forEach var="item" items="${requestScope.abonnements}" >
                                     <tr>
                                    		<td>${item['personne']['nom']}</td>
	                                        <td>${item['personne']['prenom']}</td>
	                                        <td>${item['personne']['email']}</td>
	                                        <td>${item['type']['nom_type']}</td>
	                                        <td>
	                                        <c:choose>
											  <c:when test="${item['personne']['statut'] == 1}">
											    Activer
											  </c:when>
											  <c:otherwise>
											    Desactiver
	                                        ...
	                                        <td>
	                                        	<a href="modifierGerant?update=${item['personne']['id_personne']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterGerant?consulter=${item['personne']['id_personne']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
...
<!-- Mirrored from demo.dashboardpack.com/architectui-html-pro/tables-data-tables.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Apr 2021 12:46:47 GMT -->
</html>
