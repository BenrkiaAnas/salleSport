                        ...
                        <div class="app-page-title">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${requestScope.reservations}" >
                                     <tr>
                                    		<td>${item['client']['nom']}</td>
	                                        <td>${item['client']['prenom']}</td>
	                                        <td>${item['horraire']['planning']['terrain']['nom_ter']}</td>
	                                        <td>${item['horraire']['planning']['date']}</td>
	                                        <td>${item['horraire']['heure_depart']}</td>
	                                        <td>${item['horraire']['heure_fin']}</td>
	                                        
	                                  
	                                        <td>
	                                   
	                                        	<a href="consulterReservation?consulter=${item['id_res']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
