                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            <label for="Nom" class="col-sm-2 col-form-label">Nom Client</label>
                                            <div class="col-sm-10">
                                                <label for="Nom" class=" col-form-label">${requestScope.reservation['client']['nom']}</label>
                                            </div>
                                        </div>

                                          <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Prenom Client</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="Description" class=" ">${requestScope.reservation['client']['prenom']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Terrain</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.reservation['horraire']['planning']['terrain']['nom_ter']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Planning</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.reservation['horraire']['planning']['date']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Heure Depart</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.reservation['horraire']['heure_depart']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Heure Fin</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.reservation['horraire']['heure_fin']}</p>
                                            </div>
                                        </div>
