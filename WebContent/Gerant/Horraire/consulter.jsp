...
<head>
    ...
    <title>Consulter Horraire</title>
    <meta name="viewport"
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            <label for="Nom" class="col-sm-2 col-form-label">Terrain</label>
                                            <div class="col-sm-10">
                                                <label for="Nom" class=" col-form-label">${requestScope.horraire['planning']['terrain']['nom_ter']}</label>
                                            </div>
                                        </div>
                                          ...
                                          <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="Description" class=" ">${requestScope.horraire['planning']['date']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Heure Depart</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.horraire['heure_depart']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Heure Fin</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.horraire['heure_fin']}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label for="check" class=" col-form-label">${requestScope.horraire['statut'] == 1 ? 'Activer' : 'Desactiver'}</label>
