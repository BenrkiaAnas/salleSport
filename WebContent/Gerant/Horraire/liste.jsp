                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <c:forEach var="item" items="${requestScope.horraires}" >
                                     <tr>
                                    		<td>${item['planning']['terrain']['nom_ter']}</td>
	                                        <td>${item['planning']['date']}</td>
	                                        ...
	                                        <td>
	                                        	<a href="modifierHorraire?update=${item['id_hor']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterHorraire?consulter=${item['id_hor']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
