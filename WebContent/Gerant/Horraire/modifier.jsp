                                ...
                                <div class="card-body">
                                   ...
                                   <form class=""  method="POST" action="">
                                    	<div class="position-relative row form-group">
                                            <label for="categorie" class="col-sm-2 col-form-label">Planning</label>
                                            <div class="col-sm-10">
                                                 <select class="mb-2 form-control" name="planning">
                                                 <c:forEach var="item" items="${requestScope.plannings}" >
														   <option value="${item['id_plann'] }">${item['date']} - ${item['terrain']['nom_ter']}</option>
													</c:forEach>
                                            </select>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Nom" class="col-sm-2 col-form-label">Heure Depart</label>
                                            <div class="col-sm-10">
                                                <select class="mb-2 form-control" name="heure_depart" >
                                        ...
                                        <div class="position-relative row form-group">
                                            <label for="prix" class="col-sm-2 col-form-label">Heure Fin</label>
                                            <div class="col-sm-10">
                                                <select class="mb-2 form-control" name="heure_fin" >
                                                <option value="8h">8h</option>
                                                <option value="9h">9h</option>
                                                <option value="10h">10h</option>
                                                <option value="11h">11h</option>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check">
                                                    <label class="form-check-label">
                                                        <input ${requestScope.horraire['statut'] == 1 ? 'checked' : ''} id="check" name="statut" type="checkbox" class="form-check-input " style="margin-top: 0px"!important>
                                                    </label>
                                                </div>
                                            </div>
                                        <div>
