                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                  ...
                                  <c:forEach var="item" items="${requestScope.list}" >
                                     <tr>
	                                        ...
	                                        <td>
	                                        	<a href="modificationPromotion?update=${item['id_promo']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterPromotion?consulter=${item['id_promo']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
