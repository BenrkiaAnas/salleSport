...
<head>
    ...
    <title>Consulter Promotion</title>
    <meta name="viewport"
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            <label for="NomT" class="col-sm-2 col-form-label">Dsicount</label>
                                            <div class="col-sm-10">
                                                <label for="NomT" class=" col-form-label">${requestScope.promotion['discount']}</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                ${requestScope.promotion['statut'] == 1 ? 'Activer' : 'Desactiver'}                                             
                                                </label>                                             
                                            </div>                                      
                                      </div>
                                    </form>
