                        ...
                        <div class="app-page-title">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${requestScope.accessoire}" >
                                     <tr>
                                    		<td>${item['nom_acc']}</td>
	                                        <td>${item['description']}</td>
	                                        <td>${item['prix_acc']}</td>
	                                        <td>${item['categorie']['nom_cate']}</td>
	                                        <td>
	                                        <c:choose>
	                                        ...
	                                        <td>
	                                        	<a href="modifierAccessoire?update=${item['id_acc']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterAccessoire?consulter=${item['id_acc']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
