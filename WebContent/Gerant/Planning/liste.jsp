                                ...
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                   ...
                                   <c:forEach var="item" items="${requestScope.plannings}" >
                                     <tr>
	                                        ...
	                                        <td>
	                                        	<a href="modifierPlanning?update=${item['id_plann']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterPlanning?consulter=${item['id_plann']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
