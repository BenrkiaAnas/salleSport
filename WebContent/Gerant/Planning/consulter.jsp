...
<head>
      <title>Consultation de Planning</title>
    <meta charset="utf-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            <label for="NomT" class="col-sm-2 col-form-label">Nom Terrain</label>
                                            <div class="col-sm-10">
                                                <label for="NomT" class=" col-form-label">${requestScope.planning['terrain']['nom_ter']}</label>
                                            </div>
                                        </div>
                                        
                                        <div class="position-relative row form-group">
                                            <label for="Type" class="col-sm-2 col-form-label">Date Planing</label>
                                            <div class="col-sm-10">
                                                <label for="PrixT" class=" col-form-label">${requestScope.planning['date']}</label>
                                            </div>
                                        </div>
                                      <div class="position-relative row form-group">
                                            <label for="check" class="col-sm-2 col-form-label">Status</label>                                          
                                            <div class="col-sm-10">
                                                <label for="check" class=" col-form-label">${requestScope.planning['status'] == 1 ? 'Activer' : 'Desactiver'}</label>
                                            </div>
                                        <div>
                                        </div>
                                      </div>
