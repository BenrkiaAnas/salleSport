                                ...
                                <div class="card-body">
                                 ...
                                 <form class="" method="post" action="">
                                        <div class="position-relative row form-group">
                                            <label for="NomP" class="col-sm-2 col-form-label">Nom Terrain</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label for="Date" class="col-sm-2 col-form-label">Date Planning</label>
                                            <div class="col-sm-10">
                                                <input name="date" id="date" type="date" class="form-control" value="${requestScope.planning['date']}">
                                            </div>
                                        </div>
                                      <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check">
                                                    <label class="form-check-label">
                                                        <input ${requestScope.planning['status'] == 1 ? 'checked' : ''} id="check" name="statut" type="checkbox" class="form-check-input " style="margin-top: 0px"!important>
                                                    </label>
                                                </div>
                                            </div>
                                        <div>
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2" style="padding: 0px !important">
                                                <input class="btn btn-secondary" value="Modifier" type="submit" />
                                            </div>
                                        </div>
