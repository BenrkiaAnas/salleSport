                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" method="POST" action="">
                                           ...
                                           <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                 <select class="mb-2 form-control" name="terrain">
                                                 <c:forEach var="item" items="${requestScope.terrains}" >
														   <option value="${item['id_ter'] }">${item['nom_ter']}</option>
													</c:forEach>
                                            </select>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="nomabonnement" class="col-sm-2 col-form-label">Nom Abonnement</label>
                                            <div class="col-sm-10">
                                                <input name="nom" id="nomabonnement placeholder="Nom de plan" type="text" value="${requestScope.abonnement['nom_type']}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="prixabonnement" class="col-sm-2 col-form-label">prix abonnement</label>
                                            <div class="col-sm-10">
                                                <input name="prix" id="prixabonnement" placeholder="Prix de abonnement" type="text" value="${requestScope.abonnement['prix']}" class="form-control">
                                            </div>
                                        </div>

                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Description abonnement</label>
                                            <div class="col-sm-10">
                                                <textarea name="description" id="Descriptionabonnement" class="form-control" placeholder="Description de abonnement">${requestScope.abonnement['desc_type']}</textarea>
                                            </div>
                                        </div>
                                         <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="position-relative form-check">
                                                    <label class="form-check-label">
                                                        <input ${requestScope.abonnement['statut'] == 1 ? 'checked' : ''} id="check" name="statut" type="checkbox" class="form-check-input " style="margin-top: 0px"!important>
                                                    </label>
                                                </div>
                                            </div>
                                        <div>
