...
<head>
    ...
    <title>Consulter Abonnement</title>
    <meta name="viewport"
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" >
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label for="Nom" class=" col-form-label">${requestScope.abonnement['nom_type']}</label>
                                            </div>
                                        </div>
                                          ...
                                          <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="Description" class=" ">${requestScope.abonnement['desc_type']}</p>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Description" class="col-sm-2 col-form-label">Prix</label>
                                            <div class="col-sm-10" style="padding-top: 7px">
                                                <p for="prix_acc" class=" ">${requestScope.abonnement['prix']}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label for="check" class=" col-form-label">${requestScope.abonnement['statut'] == 1 ? 'Activer' : 'Desactiver'}</label>
