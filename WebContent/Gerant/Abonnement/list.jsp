                        ...
                        <div class="app-page-title">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${requestScope.abonements}" >
                                     <tr>
                                         <td>${item['terrain']['nom_ter']}</td>
                                    		<td>${item['nom_type']}</td>
	                                        <td>${item['prix']}</td>
	                                        ...
	                                        <td>
	                                        	<a href="modifierAbonnement?update=${item['id_type_abon']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterAbonnement?consulter=${item['id_type_abon']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
									</c:forEach>
