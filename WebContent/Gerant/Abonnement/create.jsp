                                ...
                                <div class="card-body">
                                    ...
                                    <form class="" method="POST" action="">
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input name="nom" id="nomabonnement placeholder="Nom de plan" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="prixabonnement" class="col-sm-2 col-form-label">prix abonnement</label>
                                            <div class="col-sm-10">
                                                <input name="prix" id="prixabonnement" placeholder="Prix de abonnement" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="description" id="Descriptionabonnement" class="form-control" placeholder="Description de abonnement"></textarea>
                                            </div>
                                        </div>
