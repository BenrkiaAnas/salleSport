                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tr>
	                                        ...
	                                        <td>
	                                        	<a href="modifierTerrain?update=${item['id_ter']}" class="btn btn-primary">Modifier</a>
	                                        	<a href="consulterTerrain?consulter=${item['id_ter']}" class="btn btn-info">Consulter</a>
	                                        </td>
	                                 </tr>
	                                 </c:forEach>
                                    </tfoot>
