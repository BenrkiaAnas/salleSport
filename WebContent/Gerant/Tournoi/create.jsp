                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    ...
                                    <form class="" method="POST" action="">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label for="Desct" class="col-sm-2 col-form-label">Description</label>
                                            <div class="col-sm-10">
                                                <input name="description" id="Desct" type="textarea" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="PrixT" class="col-sm-2 col-form-label">Prix</label>
                                            <div class="col-sm-10">
                                                <input name="prix" id="PrixT" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Dated" class="col-sm-2 col-form-label">Date debut</label>
                                            <div class="col-sm-10">
                                                <input name="date_deb" id="Dated" type="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Datef" class="col-sm-2 col-form-label">Date fin</label>
                                            <div class="col-sm-10">
                                                <input name="date_fin" id="Datef" type="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label for="Datei" class="col-sm-2 col-form-label">Date Fin Inscription</label>
                                            <div class="col-sm-10">
                                                <input name="date_fin_inc" id="Datei" type="date" class="form-control">
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                        ...
                                        <div class="position-relative row form-check">
                                            <div class="col-sm-10 offset-sm-2" style="padding: 0px !important">
                                                <button class="btn btn-secondary">Crée</button>
                                            </div>
                                        </div>
