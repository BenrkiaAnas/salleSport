...
<head>
    ...
    <title>Affecter Promotion</title>
    <meta name="viewport"
                            ...
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    ...
                                    <form  method="POST" action="">
                                        ...
                                        <div class="position-relative row form-group">
                                            <label for="categorie" class="col-sm-2 col-form-label">Promotion</label>
                                            <div class="col-sm-10">
                                                 <select class="mb-2 form-control" name="promotion">
                                                 <c:forEach var="item" items="${requestScope.promotions}" >
														   <option value="${item['id_promo'] }">${item['discount']}</option>
													</c:forEach>
                                            </select>
                                            </div>
                                        </div>
                                         <div class="position-relative row form-group">
                                            <label for="categorie" class="col-sm-2 col-form-label">Espace</label>
                                            <div class="col-sm-10">
