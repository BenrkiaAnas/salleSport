...
<div class="group-content-center" id="women-cycle">
  ...
  <c:forEach var="terrain" items="${espace['terrains']}" >
  
  <div class="row">
      <div class="women-block">
       <!--   <h1 class="women-title home-title center-title"><span>${espace['nom_esp'] }</span></h1>-->
    ...
    <div class="row-right animMix col-sm-6" style="padding-left: 10px; padding-right: 10px;">
      ...
      <div class="product-spec">
        ...
        <li>
          ...
          <li>
            <span class="number">${espace['liked'] }</span>
            <span class="unit">Aimer</span>
          </li>
          <li>
            <span class="number">${espace['deslike'] }</span>
