  ...
  <div class="product-thumbnail__wrapper">
    <img alt="Gravida est quis euismod - black / M" class="product-thumbnail__image" src="assets/foot.jpg" />
          ...
          <th class="product__description" scope="row">
            <span class="product__description__name order-summary__emphasis">${requestScope.terrain['nom_ter']}</span>
...
<div style="display: inline-block;"><img style="margin-left: 5px;width:28px;" src="assets/racket.jpg"><span style="margin-left: 5px">${accessoire['nom_acc']}</span> - <span style="margin-left: 5px">${accessoire['prix_acc']} DH</span> </div>
          ...
          <td class="product__price">
            <span class="order-summary__emphasis skeleton-while-loading">${requestScope.terrain['prix']} DHS</span>
          </td>
        </tr>
      </tbody>
    </table>
